...
class SocietyProfileEdit extends StatefulWidget {
  static String id = 'society_profile_edit_screen';

  @override
  _SocietyProfileViewState createState() => _SocietyProfileViewState();
}

class _SocietyProfileViewState extends State<SocietyProfileEdit> {
  @override
